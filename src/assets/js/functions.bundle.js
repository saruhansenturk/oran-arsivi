        ...
        return {
            ...
            stickFooterOnSmall: function () {
                CNVS.StickFooterOnSmall &&
                    CNVS.StickFooterOnSmall.init("#footer");
            },
            ...
            portfolioAjax: function () {
                CNVS.PortfolioAjax &&
                    CNVS.PortfolioAjax.init(".portfolio-ajax");
            },
    ...
    var Modules = (function () {
        return {
            ...
            lazyLoad: function (element) {
                CNVS.LazyLoad &&
                    CNVS.LazyLoad.init(
                        element ? element : ".lazy:not(.lazy-loaded)"
                    );
            },
            ...
            modal: function (element) {
                CNVS.Modal &&
                    CNVS.Modal.init(element ? element : ".modal-on-load");
            },
            ...
            hoverAnimations: function (element) {
                CNVS.HoverAnimations &&
                    CNVS.HoverAnimations.init(
                        element ? element : "[data-hover-animate]"
                    );
            },

            gridInit: function (element) {
                CNVS.Grid &&
                    CNVS.Grid.init(element ? element : ".grid-container");
            },

            filterInit: function (element) {
                CNVS.Filter &&
                    CNVS.Filter.init(
                        element ? element : ".grid-filter,.custom-filter"
                    );
            },

            canvasSlider: function (element) {
                CNVS.CanvasSlider &&
                    CNVS.CanvasSlider.init(
                        element ? element : ".swiper_wrapper"
                    );
            },

            sliderParallax: function () {
                CNVS.SliderParallax &&
                    CNVS.SliderParallax.init(".slider-parallax");
            },

            flexSlider: function (element) {
                CNVS.FlexSlider &&
                    CNVS.FlexSlider.init(element ? element : ".fslider");
            },
            ...
            accordion: function (element) {
                CNVS.Accordion &&
                    CNVS.Accordion.init(element ? element : ".accordion");
            },

            counter: function (element) {
                CNVS.Counter &&
                    CNVS.Counter.init(element ? element : ".counter");
            },

            countdown: function (element) {
                CNVS.Countdown &&
                    CNVS.Countdown.init(element ? element : ".countdown");
            },

            gmap: function (element) {
                CNVS.GoogleMaps &&
                    CNVS.GoogleMaps.init(element ? element : ".gmap");
            },

            roundedSkills: function (element) {
                CNVS.RoundedSkills &&
                    CNVS.RoundedSkills.init(
                        element ? element : ".rounded-skill"
                    );
            },
            ...
            twitterFeed: function (element) {
                CNVS.Twitter &&
                    CNVS.Twitter.init(element ? element : ".twitter-feed");
            },

            flickrFeed: function (element) {
                CNVS.Flickr &&
                    CNVS.Flickr.init(element ? element : ".flickr-feed");
            },

            instagram: function (element) {
                CNVS.Instagram &&
                    CNVS.Instagram.init(
                        element ? element : ".instagram-photos"
                    );
            },
            ...
            navTree: function (element) {
                CNVS.NavTree &&
                    CNVS.NavTree.init(element ? element : ".nav-tree");
            },
            ...
            masonryThumbs: function (element) {
                CNVS.MasonryThumbs &&
                    CNVS.MasonryThumbs.init(
                        element ? element : ".masonry-thumbs"
                    );
            },
            ...
            ajaxForm: function (element) {
                CNVS.AjaxForm &&
                    CNVS.AjaxForm.init(element ? element : ".form-widget");
            },

            subscribe: function (element) {
                CNVS.Subscribe &&
                    CNVS.Subscribe.init(
                        element ? element : ".subscribe-widget"
                    );
            },
            ...
            shapeDivider: function (element) {
                CNVS.ShapeDivider &&
                    CNVS.ShapeDivider.init(
                        element ? element : ".shape-divider"
                    );
            },

            stickySidebar: function (element) {
                CNVS.StickySidebar &&
                    CNVS.StickySidebar.init(
                        element ? element : ".sticky-sidebar-wrap"
                    );
            },
            ...
            quantity: function (element) {
                CNVS.Quantity &&
                    CNVS.Quantity.init(element ? element : ".quantity");
            },
            ...
            ajaxTrigger: function (element) {
                CNVS.AjaxTrigger &&
                    CNVS.AjaxTrigger.init(
                        element ? element : "[data-ajax-loader]"
                    );
            },
            ...
            schemeToggle: function (element) {
                CNVS.SchemeToggle &&
                    CNVS.SchemeToggle.init(
                        element ? element : ".body-scheme-toggle"
                    );
            },
            ...
            codeHighlight: function (element) {
                CNVS.CodeHighlight &&
                    CNVS.CodeHighlight.init(
                        element ? element : ".code-highlight"
                    );
            },
            ...
            textSplitter: function (element) {
                CNVS.TextSplitter &&
                    CNVS.TextSplitter.init(
                        element ? element : ".text-splitter"
                    );
            },
            ...
            viewportDetect: function (element) {
                CNVS.ViewportDetect &&
                    CNVS.ViewportDetect.init(
                        element ? element : ".viewport-detect"
                    );
            },

            scrollDetect: function (element) {
                CNVS.ScrollDetect &&
                    CNVS.ScrollDetect.init(
                        element ? element : ".scroll-detect"
                    );
            },
            ...
            hover3D: function (element) {
                CNVS.Hover3D &&
                    CNVS.Hover3D.init(element ? element : ".hover-3d");
            },

            buttons: function (element) {
                CNVS.Buttons &&
                    CNVS.Buttons.init(
                        element ? element : ".button-text-effect"
                    );
            },
    ...
    return {
            ...
            return {
                init: function (selector) {
                    ...
                    if (
                        ...
                        __core.getVars.elWrapper.contains(
                    ...
                    if (__core.getVars.elAppMenu) {
                        if (
                            __core.viewport().height -
                                (__core.getVars.elAppMenu.getBoundingClientRect()
                                    .top +
                                    __core.getVars.elAppMenu.getBoundingClientRect()
                                        .height) ===
                            0
        ...
        Headers: (function () {
            var _offset = function () {
                ...
                __core.getVars.headerWrapOffset =
                    __core.getVars.headerOffset +
                    __core.getVars.elHeaderWrap?.offsetTop;
                __core.getVars.elHeaderWrap?.classList.remove(
                    "position-absolute"
                );

                if (elHeader.hasAttribute("data-sticky-offset")) {
                    var headerDefinedOffset =
                        elHeader.getAttribute("data-sticky-offset");
                    ...
                    if (
                        ...
                        if (
                            ...
                            if (
                                ...
                                __core.getVars.elHeader.classList.add(
            ...
            var _removeSticky = function () {
                __core.getVars.elHeader.className =
                    __core.getVars.headerClasses;
                __core.getVars.elHeader.classList.remove(
                    "sticky-header",
                    "sticky-header-shrink"
                );
                ...
                if (
                    !__core.getVars.elHeaderWrap?.classList.contains(
                        "force-not-dark"
                    )
                ) {
            ...
            var _changeMenuClass = function (type) {
                ...
                if ("responsive" == type) {
                    ...
                    if (__core.getVars.mobileHeaderClasses) {
                        newClassesArray =
                            __core.getVars.mobileHeaderClasses.split(/ +/);
                    }
                } else {
                    if (
                        !__core.getVars.elHeader.classList.contains(
                    ...
                    if (__core.getVars.stickyHeaderClasses) {
                        newClassesArray =
                            __core.getVars.stickyHeaderClasses.split(/ +/);
                    }
                }
                    ...
                    for (i = 0; i < noOfNewClasses; i++) {
                        if (newClassesArray[i] == "not-dark") {
                            ...
                            if (
                                ...
                                __core.getVars.elHeaderWrap?.classList.add(
                                    "not-dark"
                                );
                            }
            ...
            var _includeHeader = function () {
                ...
                elHeaderInc.style.marginTop =
                    __core.getVars.headerHeight * -1 + "px";
                ...
                if (headerTrigger) {
                    headerTrigger.onclick = function (e) {
                        ...
                        __core.getVars.elBody.classList.contains(
                            ...
                            __core.getVars.elBody.classList.toggle(
                                "side-header-open"
                            );
                    };
                }
            ...
            return {
                init: function (selector) {
                    ...
                    var isSticky = elHeader.classList.contains("no-sticky")
                        ...
                        : true;
                    var headerWrapClone =
                        elHeader.querySelector(".header-wrap-clone");
                    ...
                    __core.getVars.stickyShrinkOffset =
                        elHeader.getAttribute("data-sticky-shrink-offset") ||
                        300;
        ...
        Menus: (function () {
            var _init = function () {
                ...
                var onClickTopMenus = document.querySelectorAll(
                    ".top-links.on-click"
                );
                ...
                onClickTopMenus.forEach(function (topMenu) {
                    onClickTopMenuCurrent.push(
                        topMenu.querySelector(".current")
                    );
                });
            ...
            var _reset = function () {
                ...
                __core.getVars.elPrimaryMenus.forEach(function (el) {
                    if (!body.classList.contains("is-expanded-menu")) {
                        ...
                        el.querySelectorAll(subMenusSel)?.forEach(function (
                            item
                        ) {
            ...
            var _arrows = function () {
                ...
                document
                    .querySelectorAll(".menu-item")
                    .forEach(function (menuItem) {
                        var menuItemDiv = menuItem.querySelector(
                            ":scope > .menu-link > div"
                        );
                ...
                document
                    ...
                    .forEach(function (menuItem) {
                        var menuItemDiv =
                            menuItem.querySelector(":scope > a > div");
                        menuItem.querySelector(
                            ":scope > .page-menu-sub-menu"
                        ) && addArrow(menuItemDiv);
                    });
            };
            ...
            var _functions = function () {
                ...
                if (!body.contains("is-expanded-menu")) {
                    ...
                    triggers.forEach(function (trigger) {
                        trigger.onclick = function (e) {
                            ...
                            if (
                                !trigger.classList.contains("sub-menu-trigger")
                            ) {
                                triggerEl = trigger
                                    .closest(menuItemSel)
                                    .querySelector(
                                        ":scope > " + subMenuTriggerSel
                                    );
                            }
                            ...
                            __core
                                ...
                                .forEach(function (item) {
                                    item.querySelectorAll(subMenusSel).forEach(
                                        function (item) {
                            ...
                            if (triggerEl.closest(".mega-menu-content")) {
                                ...
                                [].slice
                                    ...
                                    .filter(function (item) {
                                        return !parentSubMenuContainers.includes(
                                            item
                                        );
                                    })
                                    .forEach(function (item) {
                ...
                if (body.contains("is-expanded-menu")) {
                    if (
                        body.contains("side-header") ||
                        body.contains("overlay-menu")
                    ) {
                    ...
                    [].slice
                        ...
                        .forEach(function (pMenu) {
                            ...
                            menuItemSubs.forEach(function (el) {
                                var triggerEl = el.querySelector(
                                    ":scope > .menu-link"
                                );
                                ...
                                triggerEl.onclick = function (e) {
                                    ...
                                    if (
                                        triggerEl.closest(".mega-menu-content")
                                    ) {
                                        var parentSubMenuContainers = [];
                 ...
                 */
                document
                    .querySelectorAll(".top-links")
                    .forEach(function (item) {
                        if (
                            item.classList.contains("on-click") ||
                            !body.contains("device-up-lg")
                        ) {
                            item.querySelectorAll(".top-links-item").forEach(
                                function (menuItem) {
                                    if (
                ...
                document
                    ...
                    .forEach(function (menuTrigger) {
                        menuTrigger.onclick = function (e) {
                            ...
                            var elTarget =
                                menuTrigger.getAttribute("data-target") || "*";

                            if (
                                __core.filtered(
                                    __core.getVars.elPrimaryMenus,
                                    elTarget
                                ).length < 1
                            ) {
                                return;
                            ...
                            if (!body.contains("is-expanded-menu")) {
                                __core.getVars.elPrimaryMenus.forEach(function (
                                    el
                                ) {
                                    if (
                                        el.querySelectorAll(
            ...
            var _fullWidth = function () {
                ...
                if (!body.contains("is-expanded-menu")) {
                    document
                        .querySelectorAll(
                            ".mega-menu-content, .top-search-form"
                        )
                        .forEach(function (el) {
                            el.style.width = "";
                        });
                ...
                if (
                    __core.getVars.elHeader.querySelectorAll(
                        ".container-fullwidth"
                    ).length > 0
                ) {
                    document
                ...
                if (
                    ...
                    document
                        ...
                        .forEach(function (el) {
                            el.style.width =
                                headerWidth +
                                Number(floatingHeaderPadding.split("px")[0]) *
                                    2 +
                                "px";
                        });
                }
        ...
        PageMenu: (function () {
            var _sticky = function (stickyOffset) {
                ...
                if (window.scrollY > stickyOffset) {
                    if (
                        __core.getVars.elBody.classList.contains("device-up-lg")
                    ) {
                        pageMenu.classList.add("sticky-page-menu");
                    } else {
                        if (
                            pageMenu.getAttribute("data-mobile-sticky") ==
                            "true"
                        ) {
                            pageMenu.classList.add("sticky-page-menu");
                        }
            ...
            return {
                init: function (selector) {
                    ...
                    var pageMenu = __core.getVars.elPageMenu,
                        pageMenuWrap =
                            pageMenu.querySelector("#page-menu-wrap"),
                        pageMenuClone = pageMenu.querySelector(
                    ...
                    pageMenuClone.style.height =
                        pageMenu.querySelector("#page-menu-wrap").offsetHeight +
                        "px";

                    pageMenu.querySelector("#page-menu-trigger").onclick =
                        function (e) {
                            e.preventDefault();
                    ...
                    if (
                        ...
                        __core.getVars.elHeader.getAttribute(
                            "data-sticky-shrink"
                        ) == "false"
                    ) {
                ...
                init: function (selector) {
                    ...
                    if (body.classList.contains("device-up-lg")) {
                        ...
                        if (slFlexHeight && slSwiperS) {
                            ...
                            if (
                                slSwiperFC.offsetHeight > slSwiperW.offsetHeight
                            ) {
                        ...
                        if (!body.classList.contains("stretched")) {
                            parallaxElWidth =
                                __core.getVars.elWrapper.offsetWidth;
                            if (slInner) {
                                slInner.style.width = parallaxElWidth + "px";
                            }
                        }
        ...
        SliderMenuClass: (function () {
            ...
            var _revolution = function () {
                if (
                    ...
                    var activeSlide =
                        __core.getVars.elSlider.querySelector(
                            ".active-revslide"
                        );
                    _schemeChanger(activeSlide);
                }
            ...
            var _schemeChanger = function (activeSlide) {
                ...
                if (
                    __core.getVars.elHeader.classList.contains("sticky-header")
                ) {
                    __base.headers();
                }
            };
        ...
        TopSearch: (function () {
            return {
                init: function (selector) {
                    ...
                    searchForm
                        .closest(".header-row")
                        ?.classList.add("top-search-parent");

                    var topSearchParent =
                            document.querySelector(".top-search-parent"),
                        timeout;
                    ...
                    selector[0].onclick = function (e) {
                        ...
                        if (
                            ...
                            timeout = setTimeout(function () {
                                topSearchParent?.classList.remove(
                                    "position-relative"
                                );
                            }, 500);
                        }
                        ...
                        __core.getVars.elPageMenu &&
                            __core.getVars.elPageMenu.classList.remove(
                                "page-menu-open"
                            );
        ...
        PortfolioAjax: (function () {
            ...
            var _load = function (portPostId, prevPostPortId, getIt) {
                ...
                if (getIt == false) {
                    _close();
                    __core.getVars.elBody.classList.add(
                    ...
                    fetch(portfolioDataLoader)
                        ...
                        .then(function (html) {
                            __core.getVars.portfolioAjax.container.innerHTML =
                                html;
                            ...
                            __core.getVars.portfolioAjax.items.forEach(
                                function (item) {
            ...
            var _open = function () {
                var countImages =
                    __core.getVars.portfolioAjax.container.querySelectorAll(
                        "img"
                    ).length;
            ...
            var _getNext = function (portPostId) {
                var portNext = false;
                var hasNext =
                    document.getElementById(portPostId).nextElementSibling;
            ...
            var _initAjax = function (portPostId) {
                ...
                document.getElementById("close-portfolio").onclick = function (
                    e
                ) {
                    e.preventDefault();
                    _close();
            ...
            return {
                init: function (selector) {
                    ...
                    __core.getVars.portfolioAjax.wrapper =
                        document.getElementById("portfolio-ajax-wrap");
                    __core.getVars.portfolioAjax.wrapperOffset = __core.offset(
                        __core.getVars.portfolioAjax.wrapper
                    ).top;
                    __core.getVars.portfolioAjax.container =
                        document.getElementById("portfolio-ajax-container");
                    __core.getVars.portfolioAjax.loader =
                        document.getElementById("portfolio-ajax-loader");
                    __core.getVars.portfolioAjax.prevItem = "";
        ...
        Cursor: (function () {
            return {
                init: function (selector) {
                    ...
                    var cursorFollower = document.querySelector(
                    ...
                    if (!cursor) {
                        cursor = addCursorEl(
                            ".cnvs-cursor",
                            __core.getVars.elWrapper
                        );
                    }

                    if (!cursorFollower) {
                        cursorFollower = addCursorEl(
                            ".cnvs-cursor-follower",
                            cursor
                        );
                    }
        ...
        PageTransition: (function () {
            return {
                init: function (selector) {
                    ...
                    var pageTransition = document.querySelector(
                        ".page-transition-wrap"
                    );

                    var elAnimIn =
                            body.getAttribute("data-animation-in") || "fadeIn",
                    ...
                    elLoaderHtml =
                        elLoaderBefore + elLoaderHtml + elLoaderAfter;
                    ...
                    if (!pageTransition) {
                        ...
                        body.prepend(divPT);
                        pageTransition = document.querySelector(
                            ".page-transition-wrap"
                        );
                    }
                    ...
                    var endPageTransition = function () {
                        ...
                        var removePageTransition = function () {
                            ...
                            if (elAnimIn != "fadeIn") {
                                __core.getVars.elWrapper.classList.remove(
                                    "not-animated"
                                );
                                (elAnimIn + " animated")
                                    .split(" ")
                                    .forEach(function (_class) {
                                        __core.getVars.elWrapper.classList.add(
                                            _class
                                        );
                                    });
                            }
        ...
        DataHeights: (function () {
            return {
                init: function (selector) {
                    ...
                    selector.forEach(function (el) {
                        var heightXs =
                                el.getAttribute("data-height-xs") || "auto",
                            heightSm =
                                el.getAttribute("data-height-sm") || heightXs,
                            heightMd =
                                el.getAttribute("data-height-md") || heightSm,
                            heightLg =
                                el.getAttribute("data-height-lg") || heightMd,
                            heightXl =
                                el.getAttribute("data-height-xl") || heightLg,
                            heightXxl =
                                el.getAttribute("data-height-xxl") || heightXl,
                            body = __core.getVars.elBody.classList,
                            elHeight;
                        ...
                        if (elHeight) {
                            el.style.height = !isNaN(elHeight)
                                ? elHeight + "px"
                                : elHeight;
                        }
                    });
                        ...
                        .then(function (cond) {
                            ...
                            selector.each(function () {
                                var element = jQuery(this),
                                    ...
                                    elCloseButton =
                                        element.attr("data-close-button") ||
                                        "outside",
                                    elDisableUnder =
                                        element.attr("data-disable-under") ||
                                        600,
                                    elFixedContent =
                                        element.attr("data-content-position") ||
                                        "auto",
                                    elZoom = element.attr("data-zoom"),
                                    $body = jQuery("body");

                                elCloseButton =
                                    elCloseButton == "inside" ? true : false;
                                elFixedContent =
                                    elFixedContent == "fixed" ? true : false;
                                ...
                                if (elType == "gallery") {
                                    ...
                                    element.magnificPopup({
                                        delegate: element.hasClass(
                                            "grid-container-filterable"
                                        )
                                ...
                                if (elType == "ajax-gallery") {
                                    element.magnificPopup({
                                        delegate:
                                            'a[data-lightbox="ajax-gallery-item"]',
                                        type: "ajax",
                                        tLoading: "",
                                        closeBtnInside: elCloseButton,
                                        closeIcon: closeButtonIcon,
                                ...
                                element.on("mfpOpen", function () {
                                    var lightboxItem =
                                            jQuery.magnificPopup.instance
                                                .currItem.el,
                                        lightboxClass = jQuery(
                                            lightboxItem
                                        ).attr("data-lightbox-class"),
                                        lightboxBgClass = jQuery(
                                            lightboxItem
                                        ).attr("data-lightbox-bg-class");
                    ...
                    __core
                        ...
                        .then(function (cond) {
                            ...
                            selector.each(function () {
                                ...
                                if (elCookies == "true") {
                                    var elementCookie =
                                        __core.cookie.get(elTargetValue);
                        ...
                        function (entries, observer) {
                            entries.forEach(function (entry) {
                                var element = entry.target,
                                    ...
                                    elAnimDelayOut =
                                        element.getAttribute("data-delay-out"),
                                    elAnimDelayTime = 0,
                                ...
                                if (
                                    !element.classList.contains("not-animated")
                                ) {
            ...
            return {
                init: function (selector) {
                    ...
                    selector.forEach(function (element) {
                        var elAnimate =
                                element.getAttribute("data-hover-animate"),
                            elAnimateOut =
                                element.getAttribute(
                                    "data-hover-animate-out"
                                ) || "fadeOut",
                            elSpeed =
                                element.getAttribute("data-hover-speed") || 600,
                            elDelay = element.getAttribute("data-hover-delay"),
                            elParent =
                                element.getAttribute("data-hover-parent"),
                            elReset =
                                element.getAttribute("data-hover-reset") ||
                                "false",
                            elMobile =
                                element.getAttribute("data-hover-mobile") ||
                                "true";
                    ...
                    __core
                        ...
                        .then(function (cond) {
                            ...
                            selector.each(function () {
                                var element = jQuery(this),
                                    elTransition =
                                        element.attr("data-transition") ||
                                        "0.65s",
                                    elLayoutMode =
                                        element.attr("data-layout") ||
                                        "masonry",
                                    elStagger =
                                        element.attr("data-stagger") || 0,
                                    elBase =
                        ...
                        .then(function (cond) {
                            ...
                            selector.each(function () {
                                var element = jQuery(this),
                                    ...
                                    elActClass =
                                        element.attr("data-active-class"),
                        ...
                        .then(function (cond) {
                            ...
                            selector.forEach(function (element) {
                                ...
                                var elDirection =
                                    ...
                                    elStart =
                                        element.getAttribute("data-start") || 1,
                                    elEffect =
                                        element.getAttribute("data-effect") ||
                                        "slide",
                                    elGrabCursor =
                                        element.getAttribute("data-grab"),
                                    elParallax =
                                        element.getAttribute("data-parallax"),
                                    elAutoHeight =
                                        element.getAttribute("data-autoheight"),
                                    ...
                                    elVideoAutoPlay = element.getAttribute(
                                        "data-video-autoplay"
                                    ),
                                    elSettings =
                                ...
                                elAutoPlay = elAutoPlay
                                    ? Number(elAutoPlay)
                                    : 999999999;
                                elPauseOnHover =
                                    elPauseOnHover == "true" ? true : false;
                                elAutoPlayDisableOnInteraction =
                                    elAutoPlayDisableOnInteraction == "false"
                                        ? false
                                        : true;
                                elLoop = elLoop == "true" ? true : false;
                                elParallax =
                                    elParallax == "true" ? true : false;
                                elGrabCursor =
                                    elGrabCursor == "false" ? false : true;
                                elAutoHeight =
                                    elAutoHeight == "true" ? true : false;
                                elVideoAutoPlay =
                                    elVideoAutoPlay == "false" ? false : true;
                                elStart =
                                    elStart == "random"
                                        ? Math.floor(
                                              Math.random() *
                                ...
                                if (slideNumberCurrent) {
                                    if (elLoop == true) {
                                        slideNumberCurrent.innerHTML =
                                            cnvsSwiper.realIndex + 1;
                                    } else {
                                        slideNumberCurrent.innerHTML =
                                            cnvsSwiper.activeIndex + 1;
                                    }
                                }

                                if (slideNumberTotal) {
                                    slideNumberTotal.innerHTML =
                                        element.querySelectorAll(
                                            ".swiper-slide:not(.swiper-slide-duplicate)"
                                        ).length;
                                }
        ...
        SliderParallax: (function () {
                ...
                fastdom.measure(function () {
                    ...
                    if (
                        ...
                        if (
                            ...
                            _settings.classes.remove(
                                "slider-parallax-invisible"
                            );
                            if (
                                _settings.scrollPos.y >
                                _settings.sliderPx.offset
                            ) {
                                if (
                                    ...
                                    _setParallax(
                                        0,
                                        _transform,
                                        _settings.sliderPx.inner
                                    );
                                    _setParallax(
                                        0,
                                        _transform2,
                                        _settings.sliderPx.caption
                                    );
                                } else {
                                    _transform =
                                        (_settings.scrollPos.y -
                                ...
                                if (
                                    _settings.sliderPx.el.querySelector(
                                        ".slider-inner"
                                    )
                                ) {
                                    _setParallax(
                        ...
                        if (
                            _settings.sliderPx.el.querySelector(".slider-inner")
                        ) {
            ...
            var _offset = function () {
                ...
                if (
                    __core.getNext(__core.getVars.elSlider, "#header").length >
                    0
                ) {
            ...
            var _elementFade = function (_settings) {
                ...
                fastdom.mutate(function () {
                    if (
                        ...
                        if (
                            (_settings.header &&
                                _settings.header.classList.contains(
                                    "transparent-header"
                                )) ||
                ...
                init: function (selector) {
                    ...
                    __core
                        ...
                        .then(function (cond) {
                            ...
                            __core.getVars.resizers.sliderparallax =
                                function () {
                                    _parallax(_settings);
                                    _elementFade(_settings);
                                };
                            ...
                            selector.each(function () {
                                var element = jQuery(this),
                                    ...
                                    elAnimation =
                                        ...
                                        "slide",
                                    elEasing =
                                        element.attr("data-easing") || "swing",
                                    elDirection =
                                        element.attr("data-direction") ||
                                        "horizontal",
                                    elReverse = element.attr("data-reverse"),
                                    elSlideshow =
                                        element.attr("data-slideshow"),
                                    elPause =
                                        element.attr("data-pause") || 5000,
                                    elSpeed = element.attr("data-speed") || 600,
                                    elVideo = element.attr("data-video"),
                                    elPagi = element.attr("data-pagi"),
                                    elArrows = element.attr("data-arrows"),
                                    elArrowLeft =
                                        element.attr("data-arrow-left") ||
                                        "uil uil-angle-left-b",
                                    elArrowRight =
                                        element.attr("data-arrow-right") ||
                                        "uil uil-angle-right-b",
                                    elThumbs = element.attr("data-thumbs"),
                                    elHover = element.attr("data-hover"),
                                    elSheight =
                                        element.attr("data-smooth-height"),
                                ...
                                element.find(".flexslider").flexslider({
                                    ...
                                    start: function (slider) {
                                        ...
                                        setTimeout(function () {
                                            if (
                                                slider.parents(
                                                    ".grid-container.has-init-isotope"
                                                ).length > 0
                                            ) {
                                                slider
                                                    .parents(
                ...
                init: function (selector) {
                    ...
                    selector.forEach(function (element) {
                        ...
                        if (elHeight > divHeight) {
                            elVideo.style.left = "";
                            elVideo.style.top =
                                -((elHeight - divHeight) / 2) + "px";
                        }

                        if (elWidth > divWidth) {
                            elVideo.style.left =
                                -((elWidth - divWidth) / 2) + "px";
                            elVideo.style.top = "";
                        }
                        ...
                        .then(function (cond) {
                            ...
                            selector.each(function () {
                                var element = jQuery(this),
                                    ...
                                    elRatio =
                                        element.attr("data-ratio") || "16/9",
                                    elQuality =
                                        element.attr("data-quality") || "hd720",
                                    elOpacity =
                                        element.attr("data-opacity") || 1,
                                    elContainer =
                                        element.attr("data-container") ||
                                        "parent",
                                    elOptimize =
                                        element.attr("data-optimize") || true,
                                    elLoop = element.attr("data-loop") || true,
                                    elControls =
                                        element.attr("data-controls") || false,
                                    elVolume =
                                        element.attr("data-volume") || 50,
                                    ...
                                    elFullScreen =
                                        ...
                                        false,
                                    elCoverImage =
                                        element.attr("data-coverimage") || "",
                                    elPauseOnBlur =
                                        element.attr("data-pauseonblur") ||
                                        true,
                                    elPlayIfVisible =
                                        element.attr("data-playifvisible") ||
                                        false;
                    ...
                    __core
                        ...
                        .then(function (cond) {
                            ...
                            selector.each(function () {
                                ...
                                if (
                                    typeof windowHash !== "undefined" &&
                                    windowHash != ""
                                ) {
                                    accActive = element.find(
                                        ".accordion-header" + windowHash
                                    );
                            ...
                            selector.each(function () {
                                var element = jQuery(this),
                                    elComma = element
                                        ...
                                        .attr("data-comma"),
                                    elSep =
                                        element.find("span").attr("data-sep") ||
                                        ",",
                                    elPlaces =
                                        element
                                            .find("span")
                    ...
                    __core
                        ...
                        .then(function (cond) {
                            ...
                            selector.each(function () {
                                ...
                                setDate =
                                    dateFormat != ""
                                        ? new Date(moment(dateFormat))
                                        : new Date();

                                if (elHour && elHour < 25) {
                                    setDate.setHours(
                                        setDate.getHours() + Number(elHour)
                                    );
                                }

                                if (elMin && elMin < 60) {
                                    setDate.setMinutes(
                                        setDate.getMinutes() + Number(elMin)
                                    );
                                }

                                if (elSec && elSec < 60) {
                                    setDate.setSeconds(
                                        setDate.getSeconds() + Number(elSec)
                                    );
                                }
                        ...
                        .then(function (cond) {
                            ...
                            selector.each(function () {
                                var element = jQuery(this),
                                    ...
                                    elScroll =
                                        element.attr("data-scrollwheel") ||
                                        true,
                                    elType =
                                        element.attr("data-maptype") ||
                                        "ROADMAP",
                                    ...
                                    elConPan =
                                        element.attr("data-control-pan") ||
                                        false,
                                    elConZoom =
                                        element.attr("data-control-zoom") ||
                                        false,
                                    elConMapT =
                                        element.attr("data-control-maptype") ||
                                        false,
                                    elConScale =
                                        element.attr("data-control-scale") ||
                                        false,
                                    elConStreetV =
                                        element.attr(
                                    ...
                                    elConOverview =
                                        element.attr("data-control-overview") ||
                                        false;
                        ...
                        .then(function (cond) {
                            ...
                            selector.each(function () {
                                var element = jQuery(this),
                                    ...
                                    elSpeed =
                                        element.attr("data-speed") || 2000,
                                    elWidth = element.attr("data-width") || 4,
                                    elColor =
                                        element.attr("data-color") || "#0093BF",
                                    elTrackColor =
                                        element.attr("data-trackcolor") ||
                                        "rgba(0,0,0,0.04)";
        ...
        Twitter: (function () {
            ...
            var _time = function (time_value) {
                ...
                var delta = parseInt(
                    (relative_to.getTime() - parsed_date) / 1000
                );
            ...
            return {
                init: function (selector) {
                    ...
                    selector.forEach(function (element) {
                        ...
                        var alert = element.querySelector(
                        ...
                        .then(function (cond) {
                            ...
                            selector.each(function () {
                                var element = jQuery(this),
                                    ...
                                    elItemsXs =
                                        element.attr("data-items-xs") ||
                                        Number(elItems),
                                    elItemsSm =
                                        element.attr("data-items-sm") ||
                                        Number(elItemsXs),
                                    elItemsMd =
                                        element.attr("data-items-md") ||
                                        Number(elItemsSm),
                                    elItemsLg =
                                        element.attr("data-items-lg") ||
                                        Number(elItemsMd),
                                    elItemsXl =
                                        element.attr("data-items-xl") ||
                                        Number(elItemsLg),
                                    elItemsXxl =
                                        element.attr("data-items-xxl") ||
                                        Number(elItemsXl),
                                    ...
                                    elPagi = element.attr("data-pagi"),
                                    elMargin =
                                        element.attr("data-margin") || 20,
                                    elStage =
                                        element.attr("data-stage-padding") || 0,
                                    elMerge = element.attr("data-merge"),
                                    elStart = element.attr("data-start") || 0,
                                    elRewind = element.attr("data-rewind"),
                                    elSlideBy =
                                        element.attr("data-slideby") || 1,
                    ...
                    __core
                        ...
                        .then(function (cond) {
                            ...
                            selector.each(function () {
                                ...
                                if (
                                    element.filter(".has-init-isotope").length >
                                    0
                                ) {
                                    element.isotope({
                                        masonry: {
                            ...
                            __core.getVars.resizers.masonryThumbs =
                                function () {
                                    __modules.masonryThumbs();
                                };
                        });
                    ...
                    __core
                        ...
                        .then(function (cond) {
                            ...
                            var element = selector,
                                elPosition =
                                    element.attr("data-notify-position") ||
                                    "top-right",
                                elType = element.attr("data-notify-type"),
                                elMsg =
                                    element.attr("data-notify-msg") ||
                                    "Please set a message!",
                                elTimeout =
                                    element.attr("data-notify-timeout") || 5000,
                                elClose =
                                    element.attr("data-notify-close") || "true",
                                elAutoHide =
                                    element.attr("data-notify-autohide") ||
                                    "true",
                                elId =
                                    "toast-" +
                                    Math.floor(Math.random() * 10000),
                                elTrigger =
                                    element.attr("data-notify-trigger") ||
                                    "self",
                            ...
                            var toastElement =
                                    element.attr("data-notify-target"),
                    ...
                    __core
                        ...
                        .then(function (cond) {
                            ...
                            selector.each(function () {
                                var element = jQuery(this),
                                    elTyped =
                                        element.attr("data-typed") || "false",
                                    elRotator = element.find(".t-rotate"),
                                    elAnimation =
                                        element.attr("data-rotate") || "fade",
                                    elSpeed =
                                        element.attr("data-speed") || 1200,
                                    elSep =
                                        element.attr("data-separator") || ",";

                                if (elTyped == "true") {
                                    var elTexts = elRotator.html().split(elSep),
                                        elLoop =
                                            element.attr("data-loop") || "true",
                                        elShuffle =
                                            element.attr("data-shuffle"),
                                        elCur =
                                            element.attr("data-cursor") ||
                                            "true",
                                        elSpeed =
                                            element.attr("data-speed") || 50,
                                        elBackSpeed =
                                            element.attr("data-backspeed") ||
                                            30,
                                        elBackDelay =
                                            element.attr("data-backdelay");
            ...
            var _position = function () {
                __core.getVars.elOnePageMenus &&
                    __core.getVars.elOnePageMenus.forEach(function (el) {
                        el.querySelectorAll("[data-href]").forEach(function (
                            item
                        ) {
                            item.closest(
                                __core.getVars.elOnePageParentSelector
            ...
            return {
                init: function (selector) {
                    ...
                    selector.forEach(function (el) {
                        var field = el,
                            condition =
                                field.getAttribute("data-condition") || "==",
                            conditionTarget = field.getAttribute(
                                "data-condition-target"
                            ),
                            conditionValue = field.getAttribute(
                                "data-condition-value"
                            ),
                            conditionCheck =
                                field.getAttribute("data-condition-check") ||
                                "value",
            ...
            return {
                init: function (selector) {
                    ...
                    selector.forEach(function (element) {
                        ...
                        if (
                            element.classList.contains("shape-divider-complete")
                        ) {
                            return true;
                        }
                        ...
                        width =
                            "width: calc( " + Number(elWidth) + "% + 1.5px );";
                    ...
                    __core
                        ...
                        .then(function (cond) {
                            ...
                            selector.each(function () {
                                var element = jQuery(this),
                                    elTop =
                                        element.attr("data-offset-top") || 110,
                                    elBottom =
                                        element.attr("data-offset-bottom") ||
                                        50;
            ...
            return {
                init: function (selector) {
                    ...
                    var cookieBar = document.querySelector(".gdpr-settings"),
                        ...
                        elSize,
                        elSettings = document.querySelector(
                            ".gdpr-cookie-settings"
                        ),
                        elSwitches =
                            elSettings?.querySelectorAll("[data-cookie-name]");
                    ...
                    var gdprAcceptBtn =
                            document.querySelectorAll(".gdpr-accept"),
                        gdprDeclineBtn =
                            document.querySelectorAll(".gdpr-decline"),
                        gdprSaveCookies =
                            document.querySelectorAll(".gdpr-save-cookies");
                    ...
                    if (gdprAcceptBtn.length > 0) {
                        gdprAcceptBtn.forEach(function (btn) {
                            btn.onclick = function (e) {
                                ...
                                __core.cookie.set(
                                    "__cnvs_cookies_accept",
                                    "1",
                                    elExpire
                                );
                                __core.cookie.set(
                                    "__cnvs_cookies_decline",
                                    "0",
                                    elExpire
                                );
                    ...
                    var acceptCookies = __core.cookie.get(
                            "__cnvs_cookies_accept"
                        ),
                        declineCookies = __core.cookie.get(
                            "__cnvs_cookies_decline"
                        ),
                        cookiesAllowed =
                    ...
                    elSwitches?.forEach(function (el) {
                        var elCookie =
                                "__cnvs_gdpr_" +
                                el.getAttribute("data-cookie-name"),
                    ...
                    if (gdprSaveCookies.length > 0) {
                        gdprSaveCookies.forEach(function (btn) {
                            btn.onclick = function (e) {
                                ...
                                if (
                                    elSettings.closest(".mfp-content").length >
                                    0
                                ) {
                                    jQuery$.magnificPopup.close();
                                }
                    ...
                    document
                        ...
                        ?.forEach(function (element) {
                            var elCookie =
                                    "__cnvs_gdpr_" +
                                    element.getAttribute("data-cookie-name"),
                                elContent = element.getAttribute(
                                    "data-cookie-content"
                                ),
            ...
            return {
                init: function (selector) {
                    ...
                    selector.forEach(function (el) {
                        var element = el,
                            elSize =
                                element.getAttribute("data-readmore-size") ||
                                "10rem",
                            elSpeed =
                                element.getAttribute("data-readmore-speed") ||
                                500,
                            elScrollUp =
                                element.getAttribute(
                                    "data-readmore-scrollup"
                                ) || "false",
                            elTrigger =
                        ...
                        var elHeightN =
                            elHeight + elTriggerElement.offsetHeight;
                        ...
                        var elMaskD =
                                element.getAttribute("data-readmore-mask") ||
                                "true",
                            elMaskColor =
                                element.getAttribute(
                                    "data-readmore-maskcolor"
                                ) || "#FFF",
                            elMaskSize =
                                element.getAttribute(
                                    "data-readmore-masksize"
                                ) || "100%";
                    ...
                    selector.forEach(function (element) {
                        var elCheck = element.querySelectorAll(
                            ...
                            elDefClass =
                                ...
                                "text-muted op-05",
                            elActClass =
                                element.getAttribute("data-active-class") ||
                                "fw-bold",
                ...
                init: function (selector) {
                    ...
                    selector.forEach(function (el) {
                        var params = {
                            ...
                            triggerType:
                                el.getAttribute("data-ajax-trigger-type") ||
                                "click",
                            loadDelay:
                                el.getAttribute("data-ajax-load-delay") || 2222,
                            container: document.querySelector(
                                el.getAttribute("data-ajax-container")
                            ),
                            contentPlacement:
                                el.getAttribute("data-ajax-insertion") ||
                                "append",
                            triggerHide:
                                el.getAttribute("data-ajax-trigger-hide") ||
                                "true",
                            triggerDisable:
                                el.getAttribute("data-ajax-trigger-disable") ||
                                "true",
                            loadCSS:
                                el.getAttribute("data-ajax-loadcss") || false,
                            loadJS:
                                el.getAttribute("data-ajax-loadjs") || false,
                        };
                ...
                init: function (selector) {
                    ...
                    selector.forEach(function (element) {
                        element.onclick = function (e) {
                            ...
                            var videoContent =
                                    element.getAttribute("data-video-html"),
                                videoRatio =
                                    element.getAttribute("data-video-ratio") ||
                                    "ratio ratio-16x9",
                                videoPreviewEl = element.querySelector(
                                    ".video-facade-preview"
                                ),
                                videoContentEl = element.querySelector(
        ...
        SchemeToggle: (function () {
            var _toggle = function (element, sibling = false, action = false) {
                ...
                var classAdd =
                    element.getAttribute("data-add-class") ||
                    "scheme-toggler-active";
                var classRemove =
                    element.getAttribute("data-remove-class") ||
                    "scheme-toggler-active";
            ...
            return {
                init: function (selector) {
                    ...
                    selector.forEach(function (element) {
                        var bodyClassToggle =
                            element.getAttribute("data-bodyclass-toggle") ||
                            "dark";
                        var toggleType =
                            element.getAttribute("data-type") || "trigger";

                        _toggle(element);

                        if ("checkbox" == toggleType) {
                            var elementCheck = element.querySelector(
                                "input[type=checkbox]"
                            );

                            elementCheck.addEventListener(
                                "change",
                                function () {
                                    __core.classesFn(
                                        "toggle",
                        ...
                        .then(function (cond) {
                            ...
                            selector.forEach(function (el) {
                                var trigger = el.querySelector("button"),
                                    ...
                                    copiedtext =
                                        trigger.getAttribute("data-copied") ||
                                        "Copied",
                                    copiedTimeout =
                    ...
                    __core
                        ...
                        .then(function (cond) {
                            ...
                            (function () {
                                ...
                                if (
                                    __core.cookie.get("__cnvs_tips_cookies") ==
                                    "hide"
                                ) {
                                    enabled = false;
                                }
            ...
            return {
                init: function (selector) {
                    ...
                    selector.forEach(function (mediaWrap) {
                        ...
                        var mediaDuration =
                            mediaWrap.querySelector(".media-duration");
            ...
            return {
                init: function (selector) {
                    ...
                    selector.forEach(function (el) {
                        ...
                        var elClass =
                            el.getAttribute("data-viewport-class") || "";
                        var elClassOut =
                            el.getAttribute("data-viewport-class-out") || "";
                        var elClassTarget = el.getAttribute(
                            "data-viewport-class-target"
                        );
                        var elThreshold =
                            el.getAttribute("data-viewport-threshold") || "0";
                        var elRootMargin =
                            el.getAttribute("data-viewport-rootmargin") ||
                            "0px";
                        ...
                        if (
                            elClass.includes("dark") ||
                            elClassOut.includes("dark")
                        ) {
                            hasDark = true;
                        }
                        ...
                        var observer = new IntersectionObserver(
                            function (el) {
                                el.forEach(function (entry) {
                                    ...
                                    if (entry.isIntersecting) {
                                        setTimeout(function () {
                                            elTarget.classList.add(
                                                "is-in-viewport"
                                            );

                                            elClass.forEach(function (_class) {
                                                _class &&
                                                    elClassTarget.classList.add(
                                                        _class
                                                    );
                                            });

                                            elClassOut.forEach(function (
                                                _class
                                            ) {
                                                _class &&
                                                    elClassTarget.classList.remove(
                                                        _class
                                                    );
                                            });

                                            hasDark &&
                                                _setBSTheme(elClassTarget);
                                        }, Number(elDelay));
                                    } else {
                ...
                var onScroll = function (params) {
                    fastdom.measure(function () {
                        ...
                        if (
                            ...
                            percent =
                                (startViewScroll / params.range.full) * 100;
                        ...
                        if (ratio > 0) {
                            ...
                            params.elem.classList.remove(
                                "scroll-detect-inview"
                            );
                        }

                        if (start > 0 && start < 1) {
                            params.elem.classList.add(
                                "scroll-detect-inview-start"
                            );
                        } else {
                            params.elem.classList.remove(
                                "scroll-detect-inview-start"
                            ...
                            var initParams = function (selector) {
                                ...
                                selector.forEach(function (elem) {
                                    var elemWidth = elem.offsetWidth,
                                        ...
                                        viewportHeight =
                                            __core.getVars.viewport.height,
                                        includeWidth =
                                            elem.getAttribute(
                                                "data-include-width"
                                            ),
                                        includeHeight = elem.getAttribute(
                                            "data-include-height"
                                        ),
                                        includeOffset = elem.getAttribute(
                                            "data-include-offset"
                                        ),
                                        scrollOffset =
                                            elem.getAttribute(
                                        ...
                                        parallaxRatio = elem.getAttribute(
                                            "data-parallax-ratio"
                                        ),
                                        params = {};
            ...
            return {
                init: function (selector) {
                    ...
                    selector.forEach(function (elem) {
                        ...
                        var defaultBtn =
                            elem.querySelector(".font-size-default");
                        ...
                        if (minusBtn) {
                            elem.querySelector(".font-size-minus").onclick =
                                function (e) {
                                    e.preventDefault();
                        ...
                        if (plusBtn) {
                            elem.querySelector(".font-size-plus").onclick =
                                function (e) {
                                    e.preventDefault();
                ...
                init: function (selector) {
                    ...
                    __core
                        ...
                        .then(function (cond) {
                            ...
                            var tooltipList = tooltips.map(function (
                                tooltipEl
                            ) {
                            ...
                            var popoverList = popovers.map(function (
                                popoverEl
                            ) {
                            ...
                            tabs.forEach(function (el) {
                                el.addEventListener(
                                    ...
                                    function (e) {
                                        if (
                                            !el.classList.contains(
                                                "container-modules-loaded"
                                            )
                                        ) {
                                            var tabContent = el.getAttribute(
                                                "data-bs-target"
                                            )
                                                ? el.getAttribute(
                                                      "data-bs-target"
                            ...
                            document
                                ...
                                .forEach(function (el) {
                                    el.onclick = function (e) {
                                        ...
                                        el.closest(".style-msg").classList.add(
                                            "d-none"
                                        );
                                    };
                                });
